package com.example.feature.components.card.sedouka
    ...
    PostCardUi(
        ...
        CardContents {
            Column(
                ...
                Sedouka()
                ActionIcons(
                    onProcessOfEngagementAction = { sedouka ->
                        onHomeAction(
...
fun PostCardScope.Sedouka() {
    ...
    val forthPhrase = post.description.substring(19..23)
    val fifthPhrase = post.description.substring(24..30)
    val sixthPhrase = post.description.substring(31..37)
...
@Composable
@Preview
private fun SedoukaPreview() {
    SedoukaCard(
        post = Post(description = "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"),
        hubState = HubState(),
